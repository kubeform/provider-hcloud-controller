...
type CertificateSpecResource struct {
	...
	// +optional
	DomainNames []string `json:"domainNames,omitempty" tf:"domain_names"`
	// +optional
	...
	// +optional
	NotValidAfter *string `json:"notValidAfter,omitempty" tf:"not_valid_after"`
	// +optional
	NotValidBefore *string `json:"notValidBefore,omitempty" tf:"not_valid_before"`
