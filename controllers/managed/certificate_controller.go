...
// +kubebuilder:rbac:groups=managed.hcloud.kubeform.com,resources=certificates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=managed.hcloud.kubeform.com,resources=certificates/status,verbs=get;update;patch
...
func (r *CertificateReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &managedv1alpha1.Certificate{}); err != nil {
			klog.Error(err, "unable to set up auditor", managedv1alpha1.Certificate{}.APIVersion, managedv1alpha1.Certificate{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&managedv1alpha1.Certificate{}).
