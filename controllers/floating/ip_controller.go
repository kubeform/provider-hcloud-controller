...
// +kubebuilder:rbac:groups=floating.hcloud.kubeform.com,resources=ips,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=floating.hcloud.kubeform.com,resources=ips/status,verbs=get;update;patch
...
func (r *IpReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &floatingv1alpha1.Ip{}); err != nil {
			klog.Error(err, "unable to set up auditor", floatingv1alpha1.Ip{}.APIVersion, floatingv1alpha1.Ip{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&floatingv1alpha1.Ip{}).
