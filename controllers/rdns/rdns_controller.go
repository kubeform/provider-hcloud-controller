...
// RdnsReconciler reconciles a Rdns object
type RdnsReconciler struct {
	client.Client
	Log    logr.Logger
...
// +kubebuilder:rbac:groups=rdns.hcloud.kubeform.com,resources=rdns,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=rdns.hcloud.kubeform.com,resources=rdns/status,verbs=get;update;patch

func (r *RdnsReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("rdns", req.NamespacedName)

	var unstructuredObj unstructured.Unstructured
	unstructuredObj.SetGroupVersionKind(r.Gvk)

	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Rdns")
...
func (r *RdnsReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
