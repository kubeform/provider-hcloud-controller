...
// +kubebuilder:rbac:groups=server.hcloud.kubeform.com,resources=servers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=server.hcloud.kubeform.com,resources=servers/status,verbs=get;update;patch
...
func (r *ServerReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &serverv1alpha1.Server{}); err != nil {
			klog.Error(err, "unable to set up auditor", serverv1alpha1.Server{}.APIVersion, serverv1alpha1.Server{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&serverv1alpha1.Server{}).
