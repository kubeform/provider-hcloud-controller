...
// +kubebuilder:rbac:groups=volume.hcloud.kubeform.com,resources=volumes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=volume.hcloud.kubeform.com,resources=volumes/status,verbs=get;update;patch
