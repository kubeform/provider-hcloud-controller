...
// +kubebuilder:rbac:groups=network.hcloud.kubeform.com,resources=networks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.hcloud.kubeform.com,resources=networks/status,verbs=get;update;patch
