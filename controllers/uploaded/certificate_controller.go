...
// +kubebuilder:rbac:groups=uploaded.hcloud.kubeform.com,resources=certificates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=uploaded.hcloud.kubeform.com,resources=certificates/status,verbs=get;update;patch
...
func (r *CertificateReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &uploadedv1alpha1.Certificate{}); err != nil {
			klog.Error(err, "unable to set up auditor", uploadedv1alpha1.Certificate{}.APIVersion, uploadedv1alpha1.Certificate{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&uploadedv1alpha1.Certificate{}).
...
func (r *CertificateReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(fmt.Errorf("expected a Secret but go a %T", o), "failed to get secret for Certificate")
			return nil
		}
		...
		resourceList := &uploadedv1alpha1.CertificateList{}
