...
import (
	...
	hcloudscheme "kubeform.dev/provider-hcloud-api/client/clientset/versioned/scheme"
...
func init() {
	_ = hcloudscheme.AddToScheme(scheme)
...
func NewCmdRun(version string) *cobra.Command {
	cmd := &cobra.Command{
		Use:               "run",
		Short:             "Launch Kubeform hcloud Provider controller",
		DisableAutoGenTag: true,
		Run: func(cmd *cobra.Command, args []string) {
			klog.Infoln("Starting provider-hcloud-controller...")
			...
			mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
				...
				LeaderElectionID:       "hcloud.kubeform.com",
			})
			if err != nil {
